...
if [ $SYS = "Linux" ]; then
    ...
    LIBRARIES="-L $PFM_LIB -lpfm -lllz -lCZMIL -lnvutility -lproj -llas -lgdal -lxml2 -lpoppler -lGLU"
    export LD_LIBRARY_PATH=$PFM_LIB:$QTDIR/lib:$LD_LIBRARY_PATH
else
    DEFS="WIN32 NVWIN3X"
    LIBRARIES="-L $PFM_LIB -lpfm -lllz -lCZMIL -lnvutility -lproj -llas -lgdal -lxml2 -lpoppler -liconv -lwsock32"
